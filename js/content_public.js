...
$(function() {
	$('.js_content_admin_edit').on('click', function(e) {
		...
		if (content_admin_edit == null || content_admin_edit.closed) {
			content_admin_edit = window.open($(this).attr('href'), 'content_admin_edit', 'width=900,height=800,location=yes,resizable=yes,scrollbars=yes,status=yes,dependent=yes');
